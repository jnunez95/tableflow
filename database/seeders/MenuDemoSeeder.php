...
class MenuDemoSeeder extends Seeder
{
    ...
    {
        $tables = collect([
            ['number' => 1, 'capacity' => 2, 'status' => DiningTable::STATUS_OCCUPIED],
            ['number' => 2, 'capacity' => 4, 'status' => DiningTable::STATUS_AVAILABLE],
            ['number' => 3, 'capacity' => 4, 'status' => DiningTable::STATUS_OCCUPIED],
            ['number' => 4, 'capacity' => 6, 'status' => DiningTable::STATUS_RESERVED],
            ['number' => 5, 'capacity' => 2, 'status' => DiningTable::STATUS_AVAILABLE],
            ['number' => 6, 'capacity' => 8, 'status' => DiningTable::STATUS_OCCUPIED],
            ...
            [
                ...
                'products' => [
                    ...
                    [
                        ...
                        'image' => 'https://images.unsplash.com/photo-1608897013465-1850e4ddae2e?auto=format&fit=crop&w=800&q=80',
                    ],
                    [
            ...
            [
                ...
                'products' => [
                    [
                        ...
                        'price' => 14.00,
                        'dietary_tags' => ['Vegetarian'],
                        'image' => 'https://images.unsplash.com/photo-1624353365286-3f8ed06fdb87?auto=format&fit=crop&w=800&q=80',
                    ],
                    [
                        'name' => 'Tarta de Limón',
                        ...
                        'price' => 12.00,
                        'dietary_tags' => ['Gluten-Free'],
                        'image' => 'https://images.unsplash.com/photo-1519915028121-30d243ab01e4?auto=format&fit=crop&w=800&q=80',
                    ],
                ],
            ],
            [
                ...
                'products' => [
                    [
                        ...
                        'price' => 15.00,
                        'dietary_tags' => ['Vegan'],
                        'image' => 'https://images.unsplash.com/photo-1514362545857-3bc16c4c7d66?auto=format&fit=crop&w=800&q=80',
                    ],
                    [
                        'name' => 'Agua Mineral',
                        ...
                        'image' => 'https://images.unsplash.com/photo-1548839140-29a7492991a5?auto=format&fit=crop&w=800&q=80',
                    ],
                ],
            ],
        ];
