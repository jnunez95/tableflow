...
<template>
    <article class="flex h-full flex-col overflow-hidden rounded-lg border border-soft-blue-gray bg-surface-container-lowest transition-shadow hover:shadow-ambient">
        <div class="relative aspect-[4/3] shrink-0 overflow-hidden bg-soft-blue-gray">
            <img
        ...
        <div class="flex flex-1 flex-col p-4">
            <div class="flex items-start justify-between gap-3">
                ...
                <span class="shrink-0 font-label-lg text-label-lg text-terracotta-accent">
            ...
            <p
                ...
                class="mt-2 font-body-md text-body-md text-slate-text line-clamp-2"
            >
            ...
            <div class="mt-4 flex items-center justify-end gap-2 pt-stack-sm">
                <button
                    type="button"
